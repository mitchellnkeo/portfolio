...
export default function ProjectModal({ project, isOpen, onClose }: ProjectModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative bg-neutral-800 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-neutral-700"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 p-2 bg-neutral-700 hover:bg-neutral-600 rounded-full transition-colors"
        ...
        <div className="p-8">
          ...
          <p className="text-lg text-neutral-300 mb-6">{project.description}</p>
