...
function ProjectCard({ project, onImageClick }: ProjectCardProps) {
  return (
    <div className="group bg-white dark:bg-neutral-800 rounded-xl border-2 border-neutral-200 dark:border-neutral-700 overflow-hidden hover:border-primary-500 dark:hover:border-primary-400 transition-all duration-300 hover:shadow-2xl">
      {/* Project Image */}
      <div className="relative h-48 bg-gradient-to-br from-primary-500 to-secondary-500 overflow-hidden cursor-pointer" onClick={onImageClick}>
