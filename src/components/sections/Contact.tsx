...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 sm:py-24 lg:py-32 bg-gradient-to-b from-neutral-50 to-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            {emailLink && (
              ...
              >
                <div className="p-4 bg-primary-100 rounded-full mb-4 group-hover:bg-primary-600 transition-colors">
