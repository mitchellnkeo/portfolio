...
function ExperienceCard({ experience }: { experience: WorkExperience }) {
  return (
      ...
      {/* Timeline Dot */}
      <div className="absolute -left-[9px] top-0 w-4 h-4 bg-primary-600 dark:bg-primary-400 rounded-full border-4 border-white dark:border-neutral-800 group-hover:scale-125 transition-transform shadow-lg"></div>
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-lg p-6 shadow-md hover:shadow-xl transition-shadow duration-300 border border-neutral-200 dark:border-neutral-700">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-4">
          <div>
            <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-1">{experience.position}</h3>
            <p className="text-lg font-semibold text-primary-600 dark:text-primary-400">{experience.company}</p>
          </div>
...
export default function Experience() {
  return (
    <section id="experience" className="py-20 sm:py-24 lg:py-32 bg-neutral-50 dark:bg-neutral-800 transition-colors duration-200">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-neutral-900 dark:text-white">Work Experience</h3>
            </div>
