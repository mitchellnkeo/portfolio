...
export default function About() {
  return (
    <section id="about" className="py-20 sm:py-24 lg:py-32 bg-neutral-900">
          ...
          <ScrollFadeIn delay={200}>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-white">User Experience</p>
                    <p className="text-neutral-300">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="flex flex-col items-center p-4 rounded-lg bg-neutral-800 hover:bg-neutral-700 transition-colors group border border-neutral-700">
                  <Coffee className="w-8 h-8 text-primary-400 mb-2 group-hover:scale-110 transition-transform" />
                  <span className="text-sm font-medium text-neutral-200">Coffee</span>
                </div>
                <div className="flex flex-col items-center p-4 rounded-lg bg-neutral-800 hover:bg-neutral-700 transition-colors group border border-neutral-700">
                  <Music className="w-8 h-8 text-primary-400 mb-2 group-hover:scale-110 transition-transform" />
                  <span className="text-sm font-medium text-neutral-200">Music</span>
                </div>
                <div className="flex flex-col items-center p-4 rounded-lg bg-neutral-800 hover:bg-neutral-700 transition-colors group border border-neutral-700">
                  <Gamepad2 className="w-8 h-8 text-primary-400 mb-2 group-hover:scale-110 transition-transform" />
                  <span className="text-sm font-medium text-neutral-200">Gaming</span>
                </div>
                <div className="flex flex-col items-center p-4 rounded-lg bg-neutral-800 hover:bg-neutral-700 transition-colors group border border-neutral-700">
                  <Code className="w-8 h-8 text-primary-400 mb-2 group-hover:scale-110 transition-transform" />
                  <span className="text-sm font-medium text-neutral-200">Open Source</span>
                </div>
              </div>
            </div>
          </div>
