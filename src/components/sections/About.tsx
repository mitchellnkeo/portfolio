          ...
          <ScrollFadeIn delay={200}>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <Code className="w-6 h-6 text-primary-500 flex-shrink-0 mt-1" />
                  <div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="flex flex-col items-center p-4 rounded-lg bg-neutral-50 hover:bg-neutral-100 transition-colors group border border-neutral-200">
